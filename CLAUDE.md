...
- A plan class with no time is placed in the next blank DisplayAI time row after the class before it, so an afternoon Vertical gives no times for still appears rather than vanishing
