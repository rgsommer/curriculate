...
const TeacherProfileSchema = new Schema(
  {
    ...
    // Multi-room labels for scavenger hunts
    locationOptions: {
      type: [String],
      default: [],
    },

    // Voice settings (optional; used by TeacherProfile UI)
    ...
    jeopardyDefaultAnswerMode: { type: String, default: "buzz-first" },
    jeopardyAllowNegativeScores: { type: Boolean, default: false },
    jeopardyAllowRebound: { type: Boolean, default: false },
