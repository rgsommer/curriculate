...
const faqs = [
  {
    q: "Is it really free?",
    a: "Yes. Prism is free for all teachers worldwide. No account required, no hidden limits during our launch period.",
  },
  {
          ...
          <div className="rounded-2xl bg-emerald-50 border border-emerald-200 p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs font-extrabold text-emerald-800">
                Prism Feedback — Encouraging Coach
              </span>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-lg sm:text-xl text-gray-700 font-medium max-w-xl mb-8 leading-relaxed">
                Prism — AI-powered grading for written work, handwriting, video performances,
