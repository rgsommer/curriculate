...
const faqs = [
  {
    q: "Is it really free?",
    a: "Yes. The AI grading tool is free for all teachers worldwide. No account required, no hidden limits during our launch period.",
  },
  {
