    ...
    <main className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-indigo-50">
      ...
      <section className="relative overflow-hidden px-6 pt-16 pb-10 sm:pt-20">
        ...
        <div className="relative mx-auto max-w-6xl">
          ...
          {/* Smart planning callout */}
          <div className="mt-8 rounded-3xl bg-white/70 p-6 shadow-sm ring-1 ring-black/5 backdrop-blur">
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-2">
            <StepCard
              ...
              desc="Set your goal and time window — Curriculate plans the mix, then generates the tasks."
              icon={
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                  <path
