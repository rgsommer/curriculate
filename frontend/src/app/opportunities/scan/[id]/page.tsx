...
import { GAP_TYPE_LABEL, type ScanResult, type GapType } from '@/lib/opportunities/types';
  ...
  if (scan.status === 'error') {
    return (
      <main className="mx-auto max-w-3xl px-5 py-24">
        ...
        <Link href="/opportunities" className="mt-6 inline-block rounded-lg bg-slate-900 px-5 py-3 text-white">
          Try another city
        </Link>
      </main>
    );
