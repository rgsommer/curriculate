...
| The BDays tab (`A1:AZ400`) | A row per birthday, keyed `"<serial> n"` like the calendar, the name ten columns along and the grade somewhere in the row. Balloons across the top of that grade's classes. |
