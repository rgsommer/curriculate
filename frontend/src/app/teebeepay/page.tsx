...
function SeoStructuredData() {
  const orgLd = {
    ...
    description:
      "TeebeePay is a multi-tenant payroll service for Papua New Guinea SMEs and bureaus, offered in two tiers: Self-service (you file with banks and IRC) or Managed bureau (a CPA reviews and files BSP batches, NASFund returns, IRC SWT remittances, and year-end Form S for you). Fortnightly pay stubs, BSP bank batch files, NASFund / NCSL returns, IRC SWT compliance, QuickBooks IIF, multi-bank splits, audit log, two-factor auth, anomaly alerts, divisions and supervisor timesheet flow, approve-via-email magic links, post-approval bank-funding summary with PDF attachment — all in one web app. Typical time saved versus manual payroll: 6–7 weeks of FTE per year for a 30-employee company.",
    contactPoint: [{
      "@type": "ContactPoint",
      contactType: "sales",
  ...
  const softwareLd = {
    ...
    operatingSystem: "Web",
    description:
      "Web-based payroll for Papua New Guinea, offered as Self-service or Managed bureau. Fortnightly pay stubs, BSP batch upload, NASFund/NCSL returns, IRC Salary or Wages Tax compliance, year-end Form S, supervisor timesheet flow with tap-to-clock-in, leave types (Annual/Sick/Bereavement/Compassionate/Maternity/Unpaid/Late/Absent-unauth) and balances, late-attendance alerts, divisions, multi-bank splits, two-factor auth, audit log, anomaly alerts, employee self-serve portal, QuickBooks IIF, year-end employer pack, post-approval bank-funding email with PDF attachment.",
    featureList: [
      "Two tiers: Self-service (PGK 9 / employee / fortnight) or Managed bureau (PGK 14 / employee / fortnight)",
      "Time savings: ~6 weeks of FTE per year vs. manual payroll (30-employee company)",
      ...
      "Year-end employer summary pack — XLSX master + per-employee PDF (Form S data)",
      ...
      "Divisions with assigned supervisors, default hours, and Timesheet mode",
      "Supervisor tap-to-clock-in / clock-out daily timesheet for hourly workers",
      "Leave types (Annual, Sick, Bereavement, Compassionate, Maternity, Unpaid, Late, Absent-unauth) with annual caps and balances report",
      "Late-attendance threshold alerts to Principal / Supervisor / Bookkeeper",
      "Per-period notes for bookkeepers",
      "Anomaly alerts when totals deviate from the 6-period median",
      "Post-approval Principal email with bank-funding total + PDF per-employee detail",
      ...
      "Audit log of every approval, edit, invite, pay adjustment and re-send",
      ...
      "Auto-train tutorials for new supervisors and bookkeepers, Steps-for-today checklists",
    ],
    offers: [
      { "@type": "Offer", name: "Self-service",    price: "9",  priceCurrency: "PGK", description: "Per employee per fortnight. You receive all outputs and file with banks and IRC yourself." },
      { "@type": "Offer", name: "Managed bureau",  price: "14", priceCurrency: "PGK", description: "Per employee per fortnight. CPA reviews and files BSP, NASFund, IRC SWT, and year-end Form S." },
      { "@type": "Offer", name: "Setup",           price: "500", priceCurrency: "PGK", description: "One-time onboarding fee, starting at K500 for up to 20 employees. Scales with headcount." },
    ],
