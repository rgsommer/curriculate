...
export const metadata: Metadata = {
  ...
  description:
    "Compare Curriculate and Blooket side by side. Curriculate offers station-based movement, 65+ task types including cloze, AI interviews, peer editing, and teach-back, plus team collaboration and off-screen learning. Blooket excels at gamified quiz review.",
  keywords: [
