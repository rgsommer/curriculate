...
const rows = [
  ...
  { label: "Task variety", c: "65+ task types: movement, photo evidence, debate, drawing, role-play, trivia, spinner, creation", b: "Primarily multiple-choice quiz formats wrapped in game themes" },
