...
const FEATURES = [
  ...
  ["📲", "Subs choose how they're reached", "Email is included and works great. Text (SMS) alerts are an optional paid add-on — a sub registered with several schools gets a clear text (\"BCS: teach Gr5 on Jun 5\") and taps Accept or Skip. One login shows them every school they serve."],
