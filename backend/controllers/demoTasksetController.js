...
const STATIC_DEMO_TASKS = {
  ...
  [TASK_TYPES.TRUTH_OR_DARE]: {
    taskType: TASK_TYPES.TRUTH_OR_DARE,
    title: "Truth or Dare — Today's Lesson",
    prompt:
      "Tap TRUTH to answer a question, or DARE to perform a quick challenge tied to today's topic. Practice mode lets you self-judge each round.",
    points: 10,
    config: {
      subject: "general",
  ...
  [TASK_TYPES.ART_VIEW]: {
    ...
    config: {
      ...
      responseSeconds: 120,
      analysisPrompts: [
        "Describe the relationship between the wave and Mount Fuji. Why might the artist have made the wave so much larger?",
        "What emotions does this artwork create? How do the colors and composition contribute to the mood?",
        "This is a woodblock print, not a painting. How might the technique affect the final look of the artwork?",
      ],
    },
  },
  ...
  [TASK_TYPES.MULTI_ROOM_SCAVENGER_HUNT]: {
    ...
    prompt: "Find the diagram your teacher described and explain what it shows. Use the hints below!",
    config: {
      pageReference: "Page 47, Figure 3.1 — The Rock Cycle Diagram",
      clueSource: "your teacher",
      clues: [
        "Search for a circular diagram with arrows connecting different rock types",
        "You should see three categories: igneous, sedimentary, and metamorphic",
        "Notice the processes labeled between the rocks — weathering, heat, pressure, melting, cooling",
        "The diagram shows how one rock type transforms into another over millions of years",
        "Look for the role of magma and lava in creating new igneous rocks",
      ],
    },
  },
