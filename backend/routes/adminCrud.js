...
const REFERRAL_BONUS_HTML = `
  <div style="margin-top:24px;padding-top:20px;border-top:1px solid #e2e8f0;">
    ...
    <table style="width:100%;border-collapse:collapse;font-size:14px;">
      ...
      <tr><td style="padding:10px 0;">🎮 <strong>Group Games — raffles, prize challenges &amp; scavenger hunts</strong> <span style="color:#16a34a;font-weight:700;">(3% to you)</span><br><span style="color:#64748b;">A raffle draw, a themed photo challenge, a scavenger hunt, or a score tournament — each with a cash pot. The best part: players <strong>don't have to be in the same place</strong> — everyone joins and contributes from their own phone, wherever they are.</span><br><a href="https://www.curriculate.net/campfirelive?start=raffle-challenge&ref={{REFERRAL_CODE}}" style="color:#d97706;font-weight:700;">Start a prize event &rarr;</a></td></tr>
    </table>
  </div>
`.trim();
