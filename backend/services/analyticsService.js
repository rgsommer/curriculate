 ...
 */
export async function buildAnalyticsForSession(session, submissions) {
  ...
  submissions.forEach((sub) => {
    ...
    const isCorrect =
      typeof scoring.isCorrect === "boolean" ? scoring.isCorrect : null;
  ...
  const classAverageAccuracy = round0(
    (totalAccuracyPct / numStudents) * 100
  );
