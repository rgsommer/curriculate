 ...
 */
export async function sendEmail({ from, to, subject, text, html, replyTo, attachments, cc }) {
  ...
  return mailer.sendMail({ from, to, subject, text, html, replyTo, attachments, cc });
}
