...
- brain-blitz: MUST include a "clues" array of 6-8 OBJECTS, each with { "clue": "descriptive hint", "answer": "vocabulary word" }. Every clue MUST have a DIFFERENT unique answer word. Answers must be SHORT (1-3 words max) vocabulary terms students can shout out, NEVER sentences, questions, computed numbers, decimals, or formulas. The CLUE is the long descriptive hint; the ANSWER is the short word. Do NOT include a top-level "correctAnswer" field.
