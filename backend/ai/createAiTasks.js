...
- brain-blitz: MUST include a "clues" array of 6-8 OBJECTS, each with { "clue": "descriptive hint", "answer": "vocabulary word" }. CRITICAL RULES: (1) Every answer MUST be a DIFFERENT unique term — NO duplicate answers allowed. (2) Answers must be SHORT (1-3 words max) plain vocabulary terms, NEVER sentences, NEVER in "What is...?" Jeopardy format, NEVER questions. Good: "regrouping", "counters", "integers". Bad: "What is regrouping?", "solve equations such as 9+w=14". (3) The CLUE is the long descriptive hint; the ANSWER is the short word. Do NOT include a top-level "correctAnswer" field.
...
- flashcards-race: MUST include an "items" array of 6-10 objects, each with { "front": "question or prompt", "answer": "short answer" }. Every card MUST have a DIFFERENT unique answer — no duplicate answers allowed.
  Example: { "taskType":"flashcards-race", "title":"Vocabulary Sprint", "prompt":"Race to answer each card!", "items":[{"front":"The result of multiplication","answer":"product"},{"front":"A number that divides evenly","answer":"factor"},{"front":"The top of a fraction","answer":"numerator"}] }
